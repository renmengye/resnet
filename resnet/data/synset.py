...
def get_index(label, sort=False):
  if sort:
    raise Exception('Not implemented')
    return synset_map_sorted[label]['index']
  else:
    return synset_map[label]['index']


def get_desc(label, sort=False):
  if sort:
    raise Exception('Not implemented')
    return synset_map_sorted[label]['desc']
  else:
    return synset_map[label]['desc']


def get_label(index, sort=False):
  if sort:
    raise Exception('Not implemented')
    return synset_list_sorted[index]['label']
  else:
